...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let processes = vec![
        Process { id: 101, name: "nginx".to_string(), cpu: 1.2, mem: 1024 },
        Process { id: 102, name: "postgres".to_string(), cpu: 4.5, mem: 4096 },
        Process { id: 103, name: "redis".to_string(), cpu: 0.8, mem: 512 },
    ];
